...
import org.iimsa.gatewayserver.response.User;
import org.iimsa.gatewayserver.response.UserResponse;
                    ...
                    return webClient
                            ...
                            .flatMap(res -> {
                                ...
                                ServerHttpRequest request = mutatedExchange.getRequest().mutate()
                                        ...
                                        .header(HEADER_ROLES, StringUtils.hasText(user.role()) ? "ROLE_" + user.role() : "")
